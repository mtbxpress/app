...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d' => 'get13dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7dService',
            '2_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d' => 'get23dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7dService',
        ...
        $this->privates = array(
            '1_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d' => true,
            '2_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d']) ? $this->services['1_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d'] : $this->get13dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7dService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d']) ? $this->services['2_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d'] : $this->get23dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7dService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0ddcdb89e20f5bf4a05155ac27a03a2ef852d38f7bcb830486743d4ba2cf8df1');
    ...
    /**
     * Gets the '1_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get13dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7dService()
    {
        return $this->services['1_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['2_3dbb4b97311c06c4cbfa08929f8e0b87732d2a46031046cc28290b7c24149e7d'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('xsnCm37WCz', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5IupJWYT62', 0, 'DmWke3cTxpLfn8H2twQvaY', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cSMbJvELy5', 0, 'DmWke3cTxpLfn8H2twQvaY', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Oonuos97vX', 0, 'DmWke3cTxpLfn8H2twQvaY', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5975e97cca4934.52636091');
    }
